...
- Toggle GPIO pins IO14 and IO33
...
- **GPIO 14**: General purpose I/O pin
...
4. **Control GPIO pins**
   ...
   Use the ON/OFF buttons to toggle GPIO 14 and GPIO 33.
...
- `GET /gpio?pin=14&state=1` - Set GPIO 14 to HIGH
- `GET /gpio?pin=14&state=0` - Set GPIO 14 to LOW
...
```bash
# Turn ON GPIO 14
curl "http://192.168.1.XXX/gpio?pin=14&state=1"
